## @knitr exercise_effects_function
...
v_states_utilities <- c("H" = "...", "..." = u_S1, "S2" = "...", "D" = u_D)
...
state_utility[occupied_state == "H"]  <- v_states_utilities["..."]
...
state_utility[occupied_state == "..."] <- v_states_utilities["S1"] 
