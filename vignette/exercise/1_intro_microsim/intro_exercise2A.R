## @knitr exercise_probs2_function
...
# HINT: the replacements are objects and/or their names, hence, use quotation 
# marks "" carefully. Only names of objects need to be wrapped with "".
...
# state is converted into the rate of death for those in the sick state. Copy
# and update the line of code above to compute the same for those in the sicker
# (S2) state.
