## @knitr solution_run_Trts_microSim
...
rowSums(m_trans_probs) == 1
all(rowSums(m_trans_probs) == 1)
# All row sums add up to 1.
...
# v_starting_states, num_sim, num_cycles, v_states_names, v_states_costs,
# v_states_utilities, m_trans_probs, cycle_length, and starting_seed
